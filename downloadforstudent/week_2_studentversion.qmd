...
*Side Note:* some helpful functions with df inspection! We can also get the first and last few items of a vector like this: (*forshadowing*)
```{r}
...
Features of a DF: It looks like a list of possibly heterogenous elements of equal length (matrix-esque list)
