...
Please download this [Week 4 Download](downloadforstudent/week_4_studentversion.qmd) to get the .qmd for this weeks lesson. Practice importing this file into your project for this series!
...
```
`filter()` is great for more complex filtering conditions, such as filtering out 
